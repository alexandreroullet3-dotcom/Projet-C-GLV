...
\begin{frame}{Classification : Les Cas Complexes}
    ...
    \begin{alertblock}{Type 3 : Courbes avec $D=7$ (Implémenté)}
        ...
        \textbf{Défi :} L'ordre $N$ n'est pas premier ($N=4n$). GLV implémenté seulement sur le sous-groupe cyclique d'ordre $n$.
    \end{alertblock}
...
\begin{frame}{Le Problème de Décomposition}
    ...
    \begin{enumerate}
        \item Trouver une base de vecteurs court du réseau (Pré-calcul).
